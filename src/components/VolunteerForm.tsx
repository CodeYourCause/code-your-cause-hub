        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              Tell us about yourself and how you'd like to contribute to
              meaningful projects.
            </p>
          </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="commitment" className="text-sm">
                      I understand this is a volunteer position and commit to
                      communicating openly about my availability and any
                      changes. *
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="learning" className="text-sm">
                      I'm eager to learn, accept feedback, and contribute
                      positively to the team and community. *
                    </Label>
                  </div>
                </div>
